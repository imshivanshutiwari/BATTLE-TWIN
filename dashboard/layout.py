...
def create_panel(title: str, panel_id: str, children=None, height="300px"):
    ...
    return html.Div(
        ...
        children=[
            html.H6(title, style={"color": NVG_COLORS["accent"], "margin": "0 0 8px 0",
...
def create_layout():
    ...
    return html.Div(
        style={"backgroundColor": NVG_COLORS["bg"], "color": NVG_COLORS["text"],
               "fontFamily": "'Courier New', monospace", "minHeight": "100vh", "padding": "8px"},
        children=[
            # Header
            html.Div(style={"borderBottom": f"2px solid {NVG_COLORS['border']}", "padding": "8px",
                            "marginBottom": "10px", "display": "flex", "justifyContent": "space-between"},
                     children=[
                         html.H4("BATTLE-TWIN C2 DASHBOARD", style={"color": NVG_COLORS["accent"], "margin": 0}),
            ...
            # Main Grid: 4 columns
            html.Div(style={"display": "grid", "gridTemplateColumns": "1fr 2fr 1fr 1fr", "gap": "8px"}, children=[
                ...
                html.Div([
                    ...
                    html.Div(style={"display": "grid", "gridTemplateColumns": "1fr 1fr", "gap": "8px"}, children=[
                        ...
                        create_panel("7. SLOPE / TRAFFICABILITY", "slope-map", height="180px"),
                    ]),
                ...
                html.Div([
                    ...
                    create_panel("10. BAYESIAN NETWORK", "bayesian-net-graph", height="200px"),
                ...
                html.Div([
                    ...
                    create_panel("16. FIRE MISSION STATUS", "fire-mission-log", height="150px"),
                ]),
            ]),

            # Bottom Row: Timelines & Alerts
            html.Div(style={"display": "grid", "gridTemplateColumns": "1fr 1fr 1fr 1fr 1fr 1fr", "gap": "8px",
